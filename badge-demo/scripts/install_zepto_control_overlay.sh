...
overlay_dst="/boot/dtb/ti/k3-am62l3-badge-zepto-control.dtbo"
uenv="/boot/uEnv.txt"
...
overlay = "ti/k3-am62l3-badge-zepto-control.dtbo"
...
echo
echo "Reboot is required before Zepto control GPIO pad changes can be validated."
